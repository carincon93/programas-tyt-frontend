import {
  ...
  interface UniversidadDataTableProps {
  ...
  export function UniversidadDataTable({
    universidades,
    setOpen,
    setOpenDelete,
    setUniversidadSelected,
  }: UniversidadDataTableProps) {
    ...
    const table = useReactTable({
      data: universidades,
      columns: columns({ setOpen, setOpenDelete, setUniversidadSelected }),
