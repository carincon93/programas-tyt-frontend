import {
  ...
  interface AsignaturaDataTableProps {
  ...
  export function AsignaturaDataTable({
    asignaturas,
    setOpen,
    setOpenDelete,
    setAsignaturaSelected,
    refreshAsignaturas
  }: AsignaturaDataTableProps) {
    ...
    const table = useReactTable({
      data: asignaturas,
      columns: columns({ setOpen, setOpenDelete, setAsignaturaSelected, refreshAsignaturas }),
    ...
    const [columnToFilter, setColumnToFilter] = useState("Nombre");
