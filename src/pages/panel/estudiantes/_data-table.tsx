import {
  ...
  interface EstudianteDataTableProps {
  ...
  export function EstudianteDataTable({
    estudiantes,
    setOpen,
    setOpenDelete,
    setEstudianteSelected,
  }: EstudianteDataTableProps) {
    ...
    const table = useReactTable({
      data: estudiantes,
      columns: columns({ setOpen, setOpenDelete, setEstudianteSelected }),
